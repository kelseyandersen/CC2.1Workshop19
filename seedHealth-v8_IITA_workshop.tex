...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{#install.packages("RColorBrewer") # remove the initial '#' if this is not yet installed}
...
\includegraphics{seedHealth-v8_IITA_workshop_files/figure-latex/unnamed-chunk-3-1.pdf}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{# install.packages("lattice") # remove '#' at beginning of line to install package}
...
\includegraphics{seedHealth-v8_IITA_workshop_files/figure-latex/unnamed-chunk-4-1.pdf}
...
\includegraphics{seedHealth-v8_IITA_workshop_files/figure-latex/unnamed-chunk-4-2.pdf}
...
\includegraphics{seedHealth-v8_IITA_workshop_files/figure-latex/unnamed-chunk-4-3.pdf}
...
\includegraphics{seedHealth-v8_IITA_workshop_files/figure-latex/unnamed-chunk-4-4.pdf}
...
\includegraphics{seedHealth-v8_IITA_workshop_files/figure-latex/unnamed-chunk-4-5.pdf}
